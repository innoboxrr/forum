...
return [
    ...
    */
    ...
    'headline_logo' => '/vendor/innoboxrr/forum/assets/images/logo-light.png',
    ...
    |--------------------------------------------------------------------------
    |
    | Forum needs to add css or javascript to the header and footer of your
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure the middleware applied to specific routes across Forum. This
