...
<div id="forum" class="forum_home">
				        		...
				        		<a class="discussion_list" href="/{{ Config::get('forum.routes.home') }}/{{ Config::get('forum.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
					        		<div class="forum_avatar">
					        			...
					        			@else
					        				...
					        				<span class="forum_avatar_circle" style="background-color:#<?= \Innoboxrr\Forum\Helpers\ForumHelper::stringToColorCode($discussion->user->{Config::get('forum.user.database_field_with_user_name')}) ?>">
					        		...
					        		<div class="forum_middle">
					        			...
					        			<span class="forum_middle_details">@lang('forum::messages.discussion.posted_by') <span data-href="/user">{{ ucfirst($discussion->user->{Config::get('forum.user.database_field_with_user_name')}) }}</span> {{ \Carbon\Carbon::createFromTimeStamp(strtotime($discussion->created_at))->diffForHumans() }}</span>
	...
	<div id="new_discussion">
    	...
    	<form id="forum_form_editor" action="/{{ Config::get('forum.routes.home') }}/{{ Config::get('forum.routes.discussion') }}" method="POST">
        	<div class="row">
	        	<div class="col-md-7">
		        	<!-- TITLE -->
            ...
            <div id="new_discussion_footer">
            	...
            	<a href="/{{ Config::get('forum.routes.home') }}" class="btn btn-default pull-right" id="cancel_discussion">@lang('forum::messages.words.cancel')</a>
